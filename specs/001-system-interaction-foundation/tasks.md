...
stage: tasks
status: approved  # Solar 于 2026-08-03 对 `3e3bcc9` 给出 Tasks Gate `PASS`；P8 为 T-058、T-063、T-064、T-061、T-062，共 62 项任务。P8 执行中：T-058、T-061 已完成。**执行顺序调整（用户裁决，2026-08-04）**：T-061 提前到 T-063 之前——T-063 要采的二次替换场景在旧代码上不可达（第一次替换系统性失败于回读）。T-061 的前置本就只是 Tasks PASS，故本调整不改任务定义、不重开 Tasks Gate；T-062 的前置不变。下一项为 T-063
